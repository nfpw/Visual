...
local whiteOverlay = Instance.new("UIGradient", G2L["15"])
whiteOverlay.Name = "WhiteOverlay"
whiteOverlay.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0.0, Color3.fromRGB(255,255,255)),
    ColorSequenceKeypoint.new(1.0, Color3.fromRGB(255,255,255))
}
whiteOverlay.Transparency = NumberSequence.new{
    NumberSequenceKeypoint.new(0.0, 0),
    NumberSequenceKeypoint.new(1.0, 1)
}
whiteOverlay.Rotation = 90
local blackOverlay = Instance.new("UIGradient", G2L["15"])
blackOverlay.Name = "BlackOverlay"
blackOverlay.Color = ColorSequence.new{
...
blackOverlay.Rotation = 0
blackOverlay.ZIndex = 6
